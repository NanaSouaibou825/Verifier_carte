		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> 
					<span class="text-dark"> <?php echo $_SESSION['username']; ?><a href="../propre_fichiers/logout.php">Déconnexion</a>
					</span>
              				</a>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3"><strong>Statistique globale des cartes</strong></h1>
										...
										<div class="card">
											<div class="card-body">
												...
												<div class="mb-0">
													...
													<span class="text-muted">Nombre des cartes enregistrées</span>
												</div>
											</div>
										</div>
										<div class="card">
									...
									<div class="col-sm-6">
										<div class="card">
											<div class="card-body">
												...
												<div class="mb-0">
													<span class="text-muted">Nombre de cartes retirées</span>
												</div>
											</div>
										</div>
										<div class="card">
						...
						<div class="col-xl-6 col-xxl-7">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Enregistrements recents</h5>
								</div>
						...
						<div class="col-12 col-md-6 col-xxl-3 d-flex order-2 order-xxl-3">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Statistiques cartes en cours, disponibles et retirées</h5>
								</div>
						...
						<div class="col-12 col-lg-8 col-xxl-9 d-flex">
							<div class="card flex-fill">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Statisque de l'année</h5>
								</div>
						...
						<div class="col-12 col-lg-4 col-xxl-3 d-flex">
							<div class="card flex-fill w-100">
								<div class="card-header">
									...
									<h5 class="card-title mb-0">Statisque du moi</h5>
								</div>
				...
				<div class="container-fluid">
					<div class="row text-muted">
						<div class="col-6 text-start">
							<p class="mb-0">
								<a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>Retrouvez vos cartes</strong></a>  <a class="text-muted" href="https://adminkit.io/" target="_blank"><strong>par un moyen rapide</strong></a>								&copy;
							</p>
						</div>
