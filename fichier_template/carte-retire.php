	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Back-card</span>
              ...
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Nouvel enregistrement</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="carte-en-cours.php">
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">En cours</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="carte-dispo.php">
              <i class="align-middle" data-feather="book"></i> <span class="align-middle">Disponibles</span>
            </a>
					</li>
              ...
              <i class="align-middle" data-feather="square"></i> <span class="align-middle">Rétirées</span>
            </a>
					</li>
